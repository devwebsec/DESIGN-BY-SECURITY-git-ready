...
Оценивай каждое измерение по одной шкале, опираясь только на evidence: 0 = UNKNOWN/не оценено; 1–3 = слабое покрытие; 4–6 = частичное покрытие; 7–8 = сильное покрытие; 9 = validated; 10 = validated + continuously measured.

Не компенсируй критический провал одного измерения высокими баллами другого. Если есть unresolved critical design flaw или critical unknown, явно укажи это рядом со score и не представляй высокий суммарный балл как доказательство безопасности.

Score не заменяет risk assessment, security gate или control validation.
